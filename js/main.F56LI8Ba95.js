				...
				ivaLore = [
					{
						...
						text: 'Я совсем забыла о парнишке в тёмном длинном пальто. Я заметила его у найденной статуи. Изо всех сил я попыталась добраться до него с помощью ракетного ранца, но не успела – он протянул руку внутрь раны статуи и вырвал её кристальное сердце.'
					}, {
