        ...
        520: function (e, t) {
            Array.prototype.includes || Object.defineProperty(Array.prototype, "includes", {
                value: function (e, t) {
                    ...
                    for (; r < o;) {
                        if ((n = a[r]) === (i = e) || "number" === typeof n && "number" === typeof i && isNaN(n) && isNaN(i)) return 1;
                        r++
                    }
                    return 0
                }
        ...
        525: function (e, t, a) {
                        ...
                        value: function () {
                            var e = this,
                                ...
                                o = n.a.createElement("section", {
                                    ...
                                    className: "section-text"
                                }, n.a.createElement("h1", null, "Читать истории..."), n.a.createElement("p", null, "Новая глава каждые две недели!")), n.a.createElement("div", null, n.a.createElement("div", {
                                    className: "fancyButton",
                        ...
                        return (a = Object(h.a)(this, (e = Object(d.a)(t))
                            ...
                            .dragLimit = 10, a.state = {
                                ...
                                for (var t = e.key, o = Object(y.a)(a.state.pearlStatus), n = 0; n < o.length; n++)
                                    if (!o[n].pressed) {
                                        ...
                                        if (o[n].letter === t && !o[n].pressed) {
                                            ...
                                            o[n].pressed = 1, a.props.isMuted || x(o[n].sound), n === o.length - 1 && a.setState({
                                                showPearl: 1
                                            }), a.setState({
                                                pearlStatus: o,
                                                justPressedKey: 1
                                ...
                                return e.champions.map(function (e) {
                                    ...
                                    return t && 0 === t.content.length && (t = 0), {
                                        name: e,
                                        storyId: t ? t._id : null
                                    }
                                })
            ...
            var L = function () {
                ...
                Y = [{
					...
					text: "Чтобы стать вождём Громового Племени, претендент должен выдержать Испытания трёх Чудищ. И сегодня молодая дева, дни юности которой ещё не минули, принимает вызов."
				}, {
					...
					text: ["«В оковах плоти ей плевать - король или дурак. ", "Пролившись, возвещает горе или битвы мрак. ", "Кипящая страстями в вас, гнев зовёт и ярость. ", "Сорвав оковы, не даёт видеть смертным старость. ", "Бежит - её уж не догнать, ", "Владельцу скоро погибать»"],
					style: {
						fontStyle: "italic"
					}
				}, {
                ...
                q = [{
						...
						text: "«Ещё до того, как мерзкое сияние Солнца впервые озарило Вердию. До того, как жалкое зверьё и человеческие выродки впервые засуетились по земле. До того, как заискрилась жизнь Отродья Амарги в этом скверном месте... не было ничего, кроме Лона Тьмы. В ней, в этой кромешной пустоте, ропот Арк’дун извивался в водовороте чёрных глубин. Мы были рождены в сокрытых разрывах мира, незримых для Богов. И пока всё обречено однажды состариться, иссохнуть и сгнить, мы, Арк’дун, будем здесь... ждать, расти и шептать... во Тьме»"
					}, {
						...
						text: "Они сказали, что мне будут поклоняться. Меня будут обожествлять."
					}, {
						...
						text: "Я дрейфовал в бесконечном бессонном море пустоты. Время омывало меня, как безмолвные волны, вздымающиеся и падающие проходящими десятилетиями. Я оставался неподвижным, застывшим, онемевшим."
					}, {
						text: "Я был на страже с особой целью, охраняя сущности моих братьев и сестёр. Чёрные урны, искусно выполненные и инкрустированные серебром, закрывали собою голые стены. Каждая неповторимая форма урны отражала уникальность души Арк’дунианца, чей прах наполнял сосуд. Мы, народ Арк’дун, покидаем наши смертные тела, когда те увядают и умирают, но наши души неиссякаемы. Они зовутся Верум, и они бессмертны."
					}, {
						text: "Верно, гробницы Арк’Дун похожи на усыпальницы других рас Вердии, но наши служат иным целям."
					}, {
						text: "Когда много лет назад Боги вышли на бой, пали и погрузили мир в долгую Глубокую Ночь, наш великий Оракул Нас’Горун предвидел эту катастрофу. В своей бесконечной мудрости он приказал запечатать наш Верум в гробницах, тихих и безопасных, до тех пор, пока не придёт время народу Арк’дун вернуться."
					}, {
						...
						text: "Сначала я решил, что это лишь игра света и тени. Живые существа неохотно вступают во владения Арк’Дун. Никогда они не проникали в наши усыпальницы, тем более в самую грандиозную и мрачную из всех. Однако это случилось. Какой-то бедный глупец вошел в мой склеп."
					}, {
                ...
                U = [{
						...
						text: "Эзмо подошёл ближе к делу: «Ну, у нас, демонов, есть поговорка: «Почеши мне крылья, и я почешу твои». Сделай что-то для меня, Араду, и я сделаю что-то для тебя». Араду присмотрелся к Эзмо и не увидел никаких крыльев. А также, Араду, похоже, уже позабыл, что Эзмо был ЕГО узником и должен был слушаться его приказов. Эзмо поднял свои когтистые лапки, закованные в большие исписанные рунами оковы:"
					}, {
						...
						text: "Эзмо снова улыбнулся во всё лицо. Араду прищурился. «Почему ты просто не скажешь мне, как его открыть, и я сделаю это сам?» – заявил он с подозрением, гордясь своей проницательностью. «Ну, потому что я должен коснуться тома, чтобы открыть» – возразил Эзмо, будто это было чем-то само собой разумеющимся. «Оу, – промямлил Араду смущённо, – тогда ладно». Араду достал книгу и совершил свою последнюю ошибку. Он отдал Гримуар в руки Эзмо."
					}, {
                ...
                K = [{
						...
						text: "По безжалостной традиции Тиоко, Ашка был изгнан из горы. Выставлен вон по одному из бесчисленных проходов, ведущих в холодный внешний мир, вдаль от тепла и уюта Сердца Горы."
					}, {
						text: "Ашка был немым, но не глупым. Он понимал, что произошло. Он понял, что был проклят. Изгнан всеми, кого он знал и любил. Он обратил свой взор наверх, к просторному, непримечательному голубому потолку над ним. Каменистый грунт был покрыт непонятным, зелёным, игольчатым мхом. Вдали странно выглядящие сталагмиты вырастали из земли, коричневые, с поверхностью будто морщины на коже, усыпанные зелёнью на вершине. Ашка был потерян и одинок в этом чужом мире. Он мог лишь идти вперёд и наблюдать."
					}, {
						text: "Вскоре Ашка оказался в руинах странного города. Должно быть, однажды это было значительным, восхитительным местом, думалось молодому Тиоко. Улицы были уставлены металлическими статуями высоких, стройных людей без масок. Их руки были простёрты к горе. Лёгкий ветерок гулял по городу, и лохмотья старых красных флагов трепетали, как птицы. Таинственные вопли отовсюду отражались эхом, и это пробирало Ашку до костей. Вокруг него витали призраки и духи, стоял вой из леденящих душу криков. Ашка предположил, что это место было проклято, как и он сам."
					}, {
						...
						text: "Но Ашка не умер. Он лишь крепко заснул."
					}, {
						...
						text: "Ашка проснулся в холоде и одиночестве. Он взглянул на свои руки. Его пальцы зудели. Странное тепло поднималось от них. Он щёлкнул пальцами, и зажёгся язычок пламени. Ашка улыбнулся, и скрытые за маской слезы проступили на его прекрасных золотых глазах. Он изрёк своё первое слово, зачарованный видом оранжевого света на его ладони."
					}, {
						text: "«Огонь»",
						style: {
							marginLeft: "46%",
                ...
                X = [{
						...
						text: "Повелитель сов преклонил и потряс голову в страхе. Остальные владыки посрывались с мест пламенными криками отчаяния и печали. Агниус повелитель Барсуков одним ударом своих могучих кулаков сотряс землю вокруг. «К порядку! Соблюдайте порядок!» – прокричал он."
					}, {
						...
						text: "Лесные обитатели содрогнулись от сказанного. Королева продолжала:"
					}, {
                ...
                croakLore = [{
						...
						text: "«Тише-тише, ведьма, всё кончено. Спокойно же, уходи в темноту»"
					}, {
						...
						text: "«Погоди, чего? И всё? Ничего нельзя сделать? Руку не спасти?» – вскричал я с плохо скрываемой паникой в голосе. Кому нужен ранид-убийца без руки для меча?.."
					}, {
						text: "Я снял накидку, и Рез осмотрел меня. Зараза распространилась за плечо и уже подбиралась к груди. Рез с изложил результаты осмотра, не без типичной тени ехидства, конечно же:"
					}, {
                ...
                pestilusLore = [{
						...
						text: "Кровавому Жрецу Фаминиусу пришла в голову самая блестящая из идей. Что если бы мы обнаружили способ вытянуть остатки силы из павшего бога? Он мог бы стать живым источником энергии. И, как Ваше Превосходительство знает, тайны всего в мире сокрыты в крови и ожидают нас."
					}, {
						...
						text: "С падением Куны да воспрянет Отагур."
					}, {
				...
				jumongLore = [{
						title: "Охотник и Звериный Принц"
					}, {
						...
						text: "Одной тёмной ночью охотник оказался в необычно густой чаще. Дремучий лес не пропускал лунного света, деревья же были бледны, подобно призракам, из их кривых стволов вырастали скрученные, как кружева, ветви."
					}, {
						text: "Охотник шёл по следу редкого животного, на такого он раньше никогда не охотился. Серебряный волк с шерстью цвета луны и огненно-рубиновыми глазами. Волк был хитёр, быстроног и проворен, тогда как охотник был хорош лишь в одном, но в этом одном он не знал себе равных."
					}, {
						text: "Как только серебряный волк внезапно оказался в поле зрения охотника, последний тут же встал как вкопанный, будто статуя, не издавая ни единого звука, подобно пауку. Животное внюхивалось в воздух, чуя неведомую ему опасность. Охотник медленно, без единого лишнего движения, достал свой лук, вложил в него стрелу, и одним незаметным глазу рывком натянул и отпустил тетиву. Вжик! Стрела за мгновение со свистом пронзила ночной воздух, и Серебряный Волк пал, тяжело повалившись на земляничный куст."
					}, {
						...
						text: "Охотник задумался. Хоть Звериный Принц и был, без сомнений, его самой примечательной поимкой, его не оставляла мысль о ещё более значительной добыче. Испытание, достойное его умений. И охотник согласился. Он осторожно вынул стрелу из плеча Принца. И Зверь отвёл его в свой замок глубоко в сердце густого леса."
					}, {
						...
						text: "«За своё милосердие ты будешь одарен любым из всех этих сокровищ. Но, выбрав одно и только одно, ты никогда уже не сможешь вернуться сюда», – сказал Звериный Принц. Охотник кивнул и принялся выбирать. Среди всех магических реликвий и роскошных богатств любопытно выделялись два предмета. Первым был рваный синий плащ, ткань которого пронизывали в постоянном движении волны бледно-зелёного свечения. Он красноречиво обещал владельцу великую силу, но что-то в силуэте плаща ясно предвещало ему не лучшую участь. Вторым предметом была изрядно потрёпанная меховая мантия из шкуры большого зверя с сохранёнными в ней клыками и глазницами, сияющими голубым ледяным светом. «Что это за штуки?» – спросил охотник."
					}, {
						text: "«Первая вещь – это Плащ Шипов. Говорят, что тому, кто его наденет, он дарует силу земли и силу бессмертия. Но цену он потребует заплатить очень большую. Вторая – Мантия Джумонга, она усиливает восприятие хозяина, позволяет ему сливаться с окружением и красться бесшумно, как лучшие из хищников. Но тоже – огромной ценой», – объяснил хозяин сокровищницы."
					}, {
						text: "Звериный Принц затаил дыхание, когда охотник потянулся к мантии из шкуры, ведь он знал, что тот не смог бы устоять перед возможностью стать ближе к зверю, коим он себя видел. Охотник на секунду замешкался и спросил: «Выбрав, я уже не смогу вернуться?». Принц отвечал почти шёпотом: «Никогда»"
					}, {
						...
						text: "Ворота захлопнулись между охотником и Звериным Принцем. Охотник неистово зарычал, поняв, что был обманут Зверем. Он стучал и ломился в ворота, но никакого ответа не было. Но, хотя и главное обещание не было сдержано, ценнейшим трофеем сама по себе была Мантия Джумонга, а живности для охоты в мире, конечно же, не поубавилось. Посему, охотник направился от замка в леса и вскоре напал на след новой жертвы."
					}
				], 
				ivaLore = [
					{
						title: "Большая находка Ивы"
					}, {
						text: "Я проснулась сегодня от шума бушующей песчаной бури снаружи. Воющий ветер, будто бешеный кабан, яростно трепал наскоро поставленную палатку. Вскоре шторм стих, я свернула палатку и направилась вглубь песчаных дюн в поиске… сама точно не знаю чего. Просто в поиске. Любая полезная штука попадала в рюкзак. Любая съедобная вещь – в желудок. Но не приходилось надеяться найти что-то стоящее – это были отдалённые земли, даже для Внешних Королевств."
					}, {
						text: "Несколько дней назад я продиралась сквозь густые зелёные джунгли, полные всяких кусачих тварей. Большущие насекомые размером с жабу сновали туда-сюда, хищные растения свисали с ветвей деревьев над головой, в попытке урвать кусочек чьей-нибудь плоти. Я продолжала идти, как всегда, подбирая любую полезную штуковину, что попадётся. Я – самый что ни на есть выживающий на подножном корме экстремал. Экстремал с больным бедром. Пока я ковыляла дальше в неизвестное, пейзаж начинал меняться."
					}, {
						...
						text: "Я запустила в голову зверю одну из моих ракет, надеясь легко уничтожить его. Прямое попадание! Но зверь только тряхнул головой и посмотрел на меня, лишь слегка оторопев. Чешуйчатое существо было определённо готово принять бой! Масло разлилось по нему и подхватило огонь от взрыва ракеты, но это лишь взбесило чудище ещё больше, и оно с пронзительным криком снова кинулось на меня."
					}, {
						text: "Я пальнула из старушки Бэсси несколько раз, но это не остановило зверя. Нужно было быстро отыскать его слабое место. Снова я взлетела на ранце, едва избежав размашистого удара лапой. И пока я взлетала, увидела боковым зрением, как шайка разбойников приблизилась к статуе."
					}, {
						text: "Их оскаленные рожи и оружие наготове явно не предвещали ничего хорошего, уж к своим годам я научилась это понимать. Я первая нашла статую, и не собиралась позволить каким-то разгильдяям свистнуть её прямо из-под носа! Зверюга подо мной, конечно же, никуда не делась, и я собиралась её использовать в своих целях. Я пролетела на ракетном ранце над этим воровским сбродом, продолжая поливать всё вокруг маслом. Создание преследовало меня по земле и разнесло толпу с лёгкостью ребёнка, топчущего муравейник. Внезапно воздух сотряс звук ружейного выстрела, и зверь тут же пал."
					}, {
						...
						text: "Несколько бандитов набросились на меня, размахивая мечами и самодельными битами. У одного из них была самодельная перчатка с лезвиями в форме когтей. Но не время было тянуть резину. Я разрядила во врагов пулемёт, двое пали замертво, хотя, эти сволочи и стерпели пару попаданий, стойкие, зараза. Я не осмеливалась выпускать ракету на таком близком расстоянии – меня бы тоже задело. Вместо этого я выстрелила пару зарядов из старушки Бэсси. Ещё один мутант отправился в лучший мир, а его друг был смертельно ранен."
					}, {
						...
						text: "В мешанине из внутренних органов и костей виднелось что-то вроде маски. В ней было что-то знакомое, что я уже раньше видела. Я сняла рюкзак и пошарилась в содержимом. «А-ха! Нашла!» – воскликнула я, вытащив медальон, о котором почти забыла."
					}, {
						text: "Когда я поднесла их друг к другу, то увидела, что на них изображён один и тот же символ. И тут на меня нахлынули воспоминания. Знак на медальоне, люди в масках вокруг меня что-то бубнят полушёпотом... Женщина пеленает меня, прячет, плачет об огненном даре, которого у меня не было... И мечта о живом огне, оставшаяся тлеющим теплом в груди. Женщина носила маску, точно такую же маску, что я нашла в животе зверя. Может быть - на самом деле, может быть - эта маска связана с моей родиной. С моим народом."
					}, {
						text: "Все эти сотни лет я странствовала по Внешним Королевствам, живя одним днём. Я не выбирала себе такой тяжёлой одинокой жизни в собирательстве и каждодневном выживании. Но теперь стало возможным сделать выбор. Я собрала вещи и оттёрла старушку Бэсси от сажи. Мой путь лежал в большой город, чтобы узнать, откуда эта маска, и ничто меня не остановит."
					}
				],
                lucieLore = [{
						title: "Алхимия мечты"
						...
						text: 'Мама подарила мне этот дневник, так что, думаю, можно и сделать в нём первую запись. Сегодня мой 13-й день рождения! Наконец-то я меньше чувствую себя ребёнком. Я почти взрослая! Я не чувствую себя так уж прямо старше, чем вчера, но что-то точно должно измениться. Воздух заряжен электричеством и искрится миллионом возможностей!'
					}, {
						text: 'Мама и папа планировали устроить мне вечеринку-сюрприз, хоть это и не было такой уж неожиданностью. Они не особо постарались спрятать воздушные шарики. Ну и что, всё равно было круто! Пришли все мои школьные друзья, даже эта заносчивая принцесска Матильда Пайнорчард. Она капризничала и плакала весь день, просто потому что ей не достался самый большой кусок торта. Можете поверить? Избалованная девчушка.'
					}, {
						text: 'Вот бы Зандер был там, он мог бы с помощью какого-нибудь крутого фокуса заставить её исчезнуть, это научило бы её хорошим манерам! Но Зандер так и не объявился! Он должен был вернуться домой от своих цирковых друзей в другой части города ещё несколько часов назад. Ну, вы знаете Зандера. Как говорит мама: «Зандер, как чёрная дыра – пространство и время теряют смысл в его присутствии». Слова настоящего профессора астрономии.'
					}, {
						text: 'Надеюсь, Зандер скоро вернётся домой, мне не терпится показать ему Набор Алхимика от Лилит Колдрон, который папа купил мне. В нём есть позолоченный тигель и ещё столько всего! Теперь ничто не помешает мне стать лучшим алхимиком всех времён!'
					}, {
						text: 'Запись №155',
						style: {
							fontStyle: "bold",
						...
						text: 'Сегодня был самый странный лучший день в моей жизни! Это будет ДЛИННАЯ запись. С чего бы начать? Что ж, Профессор Ношлин в очередной раз доказал мне, что его никчёмность находится за гранью человеческих возможностей. Сегодняшним заданием была простая трансмутация, превращение свинца в железо.'
					}, {
						text: 'Матильда Пайнорчард и её шайка пустоголовых недоучек, конечно же, беззаботно валяли дурака. Отец Матильды – директор школы, так что, ей не обязательно волноваться об успехах в классе Профессора Ношлина, но мне – да.'
					}, {
						text: 'Я открыла учебник «Пути Адепта в Алхимию» на странице 111. Это большая оплетённая кожей книга с явными следами использования, наверное, сотнями студентов до меня. Она пропахла серой, железом и углём, но мне это нравилось. Но меня ошарашило то, что было спрятано на этой странице.  Игральная карта! Туз червей – послание от Зандера.'
					}, {
						text: 'Он всегда носил с собой колоду карт, показывал с ней фокусы и тренировал ловкость рук. Но от него не было вестей уже 3 года! Откуда он знал, что я наткнусь на эту страницу? На рубашке карты были написаны 3 слова: «Звёздное небо. Вечером». Это ТОЧНО был Зандер. В детстве мы часто украдкой забирались на крышу нашего дома и любовались звёздами.'
					}, {
						...
						text: 'Позже этим вечером я перед сном изучала одну из книг, что стащила из библиотеки. Тайный том запретной алхимии. Правда, я не знаю, что в нём такого «запретного». Думаю, старые, покрытые слоем пыли профессора просто боятся инноваций. Но это меня не остановит. Эта глава была о применении искусства дистилляции для извлечения из обсидиана эссенции, что используется в Масле Теней, которая может делать предметы невидимыми. Слишком круто!'
					}, {
						text: 'Короче говоря, когда я читала, вдруг услышала странный шорох надо мной. Мог ли это быть он? Я вылезла из окна и вскарабкалась на крышу по водосточной трубе, прямо как я делала в детстве. То, что я потом увидела, было за пределами моих мечтаний.'
					}, {
						...
						text: 'Он прервал меня: «Тшшш. Я так по тебе скучал, сестрёнка, – сказал он низким размеренным голосом. – Я знаю, знаю, что было жестоко с моей стороны уходить, не сказав ни слова. Но ты знаешь маму, по-другому уйти бы не получилось. Я не хотел сопротивляться или ругаться по поводу достойности чести фамилии Дарроу для фокусника».'
					}, {
						text: 'Я понимала, что он прав. Мама никогда бы не позволила ему беспрепятственно идти к мечте стать фокусником. Но легче от этого не стало. «Но где же ты был всё это время, чем занимался? Ты стал фокусником?» - спросила я.'
					}, {
						text: 'Зандер снова мне улыбнулся: «Да-да. Я путешествовал по миру и видел много чудес. Невероятных вещей. Но, думаю, я нашёл то, что оправдывает такое длительное отсутствие. Настоящая магия. Не просто застольный фокус, не просто кролик из шляпы и ловкость рук. Я имею в виду НАСТОЯЩУЮ магию, Люси. Я уже почти постиг её. Осталось совсем чуть-чуть»'
					}, {
						text: 'Зандер выглядел отрешённым, будто его разум в тот момент был где-то очень далеко.'
					}, {
						text: '«О чём ты говоришь, Зан? НАСТОЯЩАЯ магия… но как?» - поинтересовалась я. Он долго смотрел на меня. И поцеловал в лоб.'
					}, {
						text: '«Потому я сюда и пришёл, - сказал он, – Я собираюсь сделать нечто весьма безрассудное. Но если это сработает, я буду величайшим фокусником всех времён, – он повернулся ко мне спиной и уставился на усыпанный звёздами небосвод. – Обещай сказать маме и папе, что я люблю их. И что бы ни произошло, не думайте обо мне плохого».'
					}, {
						text: 'Зандер снова повернулся ко мне, было заметно, как его зелёные глаза потухли. «Обещаешь?» – прошептал он. Я кивнула в ответ: «Обещаю, Зандер. Но, пожалуйста, будь очень осторожен. Умоляю. Я не знаю, что буду делать, если с тобой что-то случится…» Зандер просто улыбнулся своей типичной улыбкой: «Мне пора. Но скоро я вернусь, не беспокойся. Буду очень скучать. Ах, да, чуть не забыл». Он подошёл ко мне, крепко обнял и посмотрел мне в глаза:'
					}, {
						text: '«Запомни, Люси, не прекращай витать в облаках, для твоих мыслей это единственный способ парить над мыслями других!» – И он пафосным жестом взмахнул плащом, поклонился мне и спрыгнул с крыши! Я побежала к краю крыши и посмотрела вниз.'
					}, {
						text: 'Он исчез. Я выдохнула. Я обратила взор на ночное небо, глубоко вдыхая прохладный полуночный воздух. Звёзды искрились бесконечными возможностями.'
					}, {
						text: 'Запись №157',
						style: {
							fontStyle: "bold",
						...
						text: 'Попробовала формулу дистилляции обсидиана, сам процесс казался достаточно простым, но я почти разнесла потолок сарайчика, который оборудовала под лабораторию! Нужно попытаться снова с другим составом… Ртуть была с примесями? Ну да ладно, обратно к расчётам!'
					}, {
						text: 'Запись №188',
						style: {
							fontStyle: "bold",
						...
						text: 'Чёрт! Меня застукали, когда я «одалживала» кое-какие ингредиенты для зелья окаменения, которое я нашла в ТОЙ книге. Смертельный Корень и Голубая Сера. Еле удалось придумать более-менее похожую на правду отмазку; отделалась только едва ли цензурным выговором, от которого у приличного человека завяли бы уши. Надо быть поосторожнее. Может, то Масло Теней пригодилось бы…'
					}, {
						text: 'Запись №202',
						style: {
							fontStyle: "bold",
						...
						text: 'Не знаю, как, но ему удалось. Ему реально удалось. Зандер нашёл НАСТОЯЩУЮ магию! Он присоединился к труппе артистов, называющих себя Маскарад Пантомимы (так загадочно звучит!), и стал набирать известность по всему Толину. Толинцы всегда служили объектом насмешек за то, что были единственной человеческой культурой, не знавшей ни религиозной, ни научной магии. Так что, демонстрирующий магию Зандер беспрецедентен! Он на первых полосах всех газет! Он такой вдохновляющий и сногсшибательный! У меня получилось улизнуть этим вечером с несколькими друзьями и пойти на его представление.'
					}, {
						...
						text: 'Нет, этого не может быть! На первой полосе всех газет: «Было совершено нападение на Восхитительный и Мистический Маскарад Пантомимы! 12 артистов погибли, остальные пропали без вести!». Люди вокруг только и говорят об этом. Ходят даже слухи, что Зандер заключил договор с Кровавым Духом, и тот пришёл за расплатой. Газета пишет, что их всех убил… какой-то неизвестный дух или сила. Но Зандер никогда бы не заключил сделку с Кровавым Духом… так ведь? Тело Зандера так и не отыскали. Может, он в порядке. О, Зандер, пожалуйста, вернись и дай нам знать, что ты жив и здоров. Я не верю, что ты мёртв. Не верю!'
					}, {
						text: 'Запись 574',
						style: {
							fontStyle: "bold",
						...
						text: 'Но… по дороге домой я нашла листовку.'
					}, {
						text: '«Ступите на Арену! Разыскиваются Чемпионы. Требуются все: люди, звери и любые другие существа. Бейтесь за славу и золото! Запишитесь сегодня!». Без особого энтузиазма я взяла листовку и пошла домой. Позже я снова услышала шуршание на крыше! Это ведь мог быть он? Это было бы невероятно. Я пулей выскочила из постели и быстро вскарабкалась через окно на крышу, чтобы увидеть…'
					}, {
						text: 'Никого. Никого там не было. Лишь дул и завывал холодный ветер, я была одна. Я, было, повернула, чтобы слезть обратно, как вдруг заметила что-то на черепице крыши. Маленькая бумажка. Карта? На одной стороне был туз червей, а на задней… нарисованное облачко.'
					}, {
						text: 'Это был Зандер! Каким-то чудом он жив! А облако… напомнило мне сказанные им ранее слова: «Запомни, Люси, не прекращай витать в облаках, для твоих мыслей это единственный способ парить над мыслями других!»'
					}, {
				...
				talonIslandLore = [{
						...
						text: "Часть 1 - Сердце Зоранвара",
						style: {
							fontStyle: "bold",
							fontWeight: "800"
						}
					}, {
						text: "Есть место, совсем не похожее ни на одно другое на просторах Вердии. Именно там я решил зажечь первую искру жизни в этом мире. Мой первый проблеск вдохновения. Он был прекрасен в своём несовершенстве."
					}, {
						text: "Я - Зоранвар. Бог Мудрости. Ностальгируя о моей любви к искусству в юности, я создал необыкновенный цветок, чтобы он цвёл там. Нигде больше на Вердии нельзя увидеть Небосвод. Он мой и только мой, как и сам остров. И остров тот - мой первенец. Мой дом. Моё святилище. Моё вечно сокровенное."
					}, {
						text: "Я наблюдал за миром с небес, витая в облаках в моей любимой материальной форме - величественной Грозовой Виверне. Она отлично подходила, ибо небеса были моей первородной стихией. Изящно, грациозно и величаво я парил над своим королевством. И так, хотя, как будто прошли всего несколько минут, пролетели века."
					}, {
						image: "https://battlerite-ru.github.io/lore/images/stories/talonisland/dogDragonWyvernBus.jpg"
					}, {
						text: "Роскошный, яркий мир, созданный мною и моими братьями и сёстрами, начал кипеть жизнью. Мой остров, благословенный и священный, тоже развивался. Люди строили храмы и святыни в мою честь. Всё шло хорошо."
					}, {
						text: "В нашем порыве ребяческого восторга и гордости, мы с братьями и сёстрами желали показать свои творения нашему Отцу. Мы всё ещё вспоминали его с любовью как Амаргу Всеотца, хоть и были разлучены с ним на тысячелетие. Мы жаждали призвать его в наш мир."
					}, {
						text: "Теперь мы знаем, это было безрассудно."
					}, {
						text: "Было нелёгко, но, наконец, мы решились. Однако, как только мы исполнили обряд призыва, Вердии была уготована суровая судьба. Амарга объявился, но он уже был не нашим любящим родителем, но искажённой тенью себя. Испорченный, жуткий, безумно яростный."
					}, {
						text: "В гневе Амарги Вердия погрузилась во тьму и огонь. Многие из моих братьев и сестёр были повержены или пропали, но великими жертвами и усилиями мы изгнали нашего отца обратно в мир, откуда он пришёл. Оставшиеся из нас последовали за ним, чтобы снять с него эту порчу. Не знаем, сможем ли мы когда-то вернуться в наш любимый прекрасный мир."
					}, {
						image: "https://battlerite-ru.github.io/lore/images/stories/talonisland/isThisANewPestilusSkin.jpg"
					}, {
						text: "Часть 2 - Дахаринский Рыбак",
						style: {
							fontStyle: "bold",
							fontWeight: "800"
						}
					}, {
						text: "Речной народ Дахарина отважен и непреклонен, нас непросто застать в расплох или запугать. Но когда налётчики Охотников за Головами нападали на нашу небольшую деревушку, они атаковали быстро и без предупреждения."
					}, {
						text: "Охотники за Головами! Пять сотен лет их никто не видел. Поговаривали, что они погибли в дожде из огня, когда боги воевали в небесах. К тому времени, когда речной народ оправился после той долгой ночи, Охотники за Головами, похоже, исчезли."
					}, {
						text: "Но вот, они здесь. Набросились на деревню рычащей ордой. Многие из нас погибли, а те, кто выжил, покинули свои дома. Так мы и проделали наш путь к единственному убежищу, Монастырю Резонанса, вместилищу силы веры в Симфонию. "
					}, {
						text: "Я, Гедирон Мосс, простой рыбак, неважно владеющий мечом, вскоре стал во главе этой группы скитальцев. "
					}, {
						text: "Монастырь принял нас с распростёртыми объятиями, но у них не было достаточно места, чтобы приютить нас. Неприкаянные, мы не имели уголка в мире, которое могли бы назвать своим. Но затем я встретил Талайю, пылкую молодую жрицу, к которой я не мог не испытывать симпатии."
					}, {
						text: "Талайя рассказала мне об острове посреди великой реки, протекающей через весь Дахарин - место, затерянное в тумане времён. Она сказала, что он был священным для Зоранвара, древнего бога её религии. Сам я не был человеком веры. Не было богов, что ответили бы нашим молитвам во время налётов Охотников за Головами. Но в глазах Талайи жила надежда, а надежды я не видел уже очень давно."
					}, {
						text: "Талайя рассказала мне, что она и ещё несколько её соратников по вере намеревались отыскать этот остров, но им недоставало кого-то, кто мог бы управлять кораблём. Я слыл бывалым рыбаком, и по её словам, моё появление было благословением Зоранвара. Я решил помочь, но только при условии, что этот остров будет заселён моим народом. Она согласилась, и вскоре мы отплыли."
					}, {
						text: "Мы странствовали под парусами три дня и три ночи, но всеми нашими открытиями были лишь туман и мрак. Наконец, на четвёртый день, уже когда мы хотели развернуться и плыть обратно, туман рассеялся, и мы узрели его. Утопающий в зелени остров с горной вершиной в форме когтя."
					}, {
						text: "Над островом царила особенная атмосфера. Встав на якорь и высадившись там, мы обнаружили руины давно покинутых зданий и храмов. Судя по древним фрескам, Талайя действительно нашла священный остров её древнего бога."
					}, {
						image: "https://battlerite-ru.github.io/lore/images/stories/talonisland/TalonIsland03.jpg"
					}, {
						text: "Вскоре мы заселили остров и сделали его нашим домом. Время шло, и речной народ начал снова рыбачить и обрабатывать поля. Талайя и её жрецы воздвигли церковь для воздаяния молитв, а позже мы с Талайей поженились, и жители назначили меня Бароном острова. Долгие годы жизнь была прекрасна."
					}, {
						text: "Так не могло продолжаться всегда."
					}, {
						text: "Часть 3 - Кровавая Жрица",
						style: {
							fontStyle: "bold",
							fontWeight: "800"
						}
					}, {
						text: "После того, как жители деревни нашли меня, вытащили на берег и откачали, они сказали, что мои лёгкие были уже заполнены речной водой."
					}, {
						text: "Они не могли понять, как же я не утонула. Немного они знали о нас из Отагура, рождённых в океане. Единых с морем. Кровь в моих венах та же, что и у Тирмока, самого Бога Морей."
					}, {
						text: "Я солгала, сообщив им, что сбежала с корабля работорговца. Они купились, хотя и долго пялились на мою неестественно бледную кожу. Мои изумрудно-зелёные глаза и чёрные как смоль волосы вызывали ещё большее недоумение, особенно среди людей вроде них."
					}, {
						text: "Пока местные вели меня по городу, я увидела, что работа Владыки Пестилуса уже шла полным ходом. Тела сложены в смердящие кучи. Все лавки и дома закрыты с надписью «Карантин». Чума сделала своё дело. Всего-то понадобилось применить немного магии крови к реке, и рыба была заражена."
					}, {
						text: "Жители рассказывали то, что я и так уже знала: чума будто пришла из ниоткуда и принесла опустошение, как лесной пожар. Они только что вернулись от почтенной пожилой Высшей Жрицы, жены Барона, недавно ушедшего в мир иной из-за чумы. Всё шло по плану. Настало время сыграть свою роль."
					}, {
						text: "С притворной слабостью после счастливого спасения, я расспрашивала о чуме. Затем я рассказала местным, что обучена искусству исцеления, и, возможно, я смогу помочь им там, где их жрецы не смогли. Они отвели меня в их самое сокровенное место, в Храм Зоранвара."
					}, {
						text: "Жрецы и жрицы пребывали в ужасном настроении. Они были полны печали и отчаяния. Я не могла их винить. Их священная Высшая Жрица поддалась болезни, и они чувствовали, что их бог проклял их этой чумой. Я почти почувствовала на себе тень вины, осознавая, что мои деяния лежали в корне их бед, но я обязана была выполнить свою миссию. За кровь и желчь, во славу Отагура."
					}, {
						text: "Один жрец признался, что боится, что они чем-то разгневали их богов. Ни одна магия лечения не оказала никакого воздействия на чуму. Я сказала им, что видела подобную болезнь раньше. Существовали ритуалы, тёмные ритуалы, которые можно совершить для борьбы с этой болезнью."
					}, {
						text: "Они отреагировали предсказуемо – нарекли меня ведьмой и еретиком. Отправили меня в мою каморку и сказали, чтобы я убиралась восвояси, как только поправлю здоровье. Но семя тёмной надежды уже было заронено, теперь это был лишь вопрос времени. "
					}, {
						text: "Понадобилось дольше ожидаемого. Неделю провела я в своей каморке больше как заключённая, нежели гостья. Дверь открылась сразу после стука. Жрец и жрица стояли на пороге. Их лица были исполосаны глубокими язвами, а из глаз лились слёзы вперемежку с кровью. Отчаяние может заставить тебя делать вещи, которые ты бы никогда не поверил, что сделаешь."
					}, {
						text: "«Показывай свой ритуал, ведьма»"
					}, {
						text: "Я велела им отвести меня в самые дальние и тёмные места их острова. Они привели меня в склеп далеко под храмом. Чтобы магия крови сработала, нужна абсолютная, кромешная тьма. Когда мы вошли, я почувствовала… что-то не то. Тёмная энергия струилась там, едва различимая, но не было времени зацикливаться на этом, нужно было сделать свою работу."
					}, {
						text: "Жрецы думали, что я избавлю их от страданий, но это была последняя часть моего плана. Это не было заклинанием исцеления. Мы открывали портал в Отагур, где уже стояла наша армия, готовая ко вторжению. Остров послужил бы идеальной секретной базой в самом сердце этой земли слабых духом."
					}, {
						text: "Я пустила кровь у двух жрецов, затем свою, и исполняла ритуал так, как делала это уже сотню раз. Но на этот раз... на этот раз что-то пошло не так. Когда портал открылся, то были не наши солдаты, рвущиеся на эту сторону, а источник тёмной энергии, которую я чувствовала. Шепчущая Пустота."
					}, {
						text: "Кровавая Жрица Отагура осознаёт истинную мощь, когда чувствует её. Я не могла остановиться и держала портал открытым, пока Пустота с рёвом шла сквозь него."
					}, {
						image: "https://battlerite-ru.github.io/lore/images/stories/talonisland/TalonIsland04.jpg"
					}, {
						text: "Часть 4 - Возвращение Зоранвара",
						style: {
							fontStyle: "bold",
							fontWeight: "800"
						}
					}, {
						text: "Говорят, лишь немногие познавшие ярость бога выжили, чтобы рассказать другим о ней. Такой была ярость Зоранвара, когда он вернулся разбитый и утомлённый из мира за пределами даже его понимания."
					}, {
						text: "Сложно сказать, как долго Зоранвар с его братьями и сёстрами были там, в этом извращённом измерении, куда они последовали за своим отцом. Время размыто в этом кипящем аду. Там всё будто насмехается над самой жизнью, мерзкая противоположность красоты Вердии. Этот кошмарный мир бился с ними на каждом шагу, и они отвечали так же сильно. Один за другим, боги были разделены друг от друга, пока Зоранвар не остался в одиночестве. И всё же, он продолжал пытаться."
					}, {
						text: "Наконец, он нашёл источник порчи. Чёрное ничто, противоположность созиданию, пульсирующее и растущее, как опухоль. Шепчущая пустота, колеблющаяся, как волна."
					}, {
						image: "https://battlerite-ru.github.io/lore/images/stories/talonisland/TalonIsland05.jpg"
					}, {
						text: "Зоранвар не мог вспомнить, как попал обратно на Вердию. Он открыл глаза и обнаружил, что вернулся, в замешательстве, как после дурного сна. Нуждаясь в отдыхе от полутысячи лет тьмы и смерти, Зоранвар вернулся в своё старое святилище, которое теперь известно под именем Остров Когтя. Он всё ещё был обитаем. Знакомое место сначала даровало ему покой, но вскоре он понял: что-то было совсем не в порядке."
					}, {
						text: "Смрад той же пустоты, от которой он только что бежал, был здесь, сочащийся в этот мир, меняя и портя людей. Та же порча, овладевшая его Отцом Амаргой, с которым он бился пять сотен лет, принесена в его святилище его же детьми! В гневе, в котором может пребывать только бог, Зоранвар призвал призрачный ветер, что стёр с лица острова и испорченную пустоту, и всех обитателей."
					}, {
						text: "Когда пламя ярости угасло, Зоранвар остался наедине с новой проблемой. Эта порча, эта Пустота не остановится, продолжит просачиваться в его мир и расти. Он будет бороться с нею, но он понимал, что один не сможет её одолеть. Ему нужно было создать армию."
					}, {
						text: "Зоранвар собрал чемпионов со всего мира и столкнул их друг с другом. Остров, бывший однажды его святилищем, теперь принимает эту Королевскую Битву. Победители станут избранными воинами в сражении, которое определит судьбу всей Вердии."
					}
				],
				alysiaLore = [{
						title: "Желание зимы"
					}, {
						text: 'Давным-давно, в крае бесконечной зимы и вечной ночи возвышался над снегами хмурый чёрный замок.'
					}, {
						text: 'И земля та была не просто нескончаемой долиной вечной мерзлоты. Она была проклята. Народ, что населял замок, был груб и угрюм. Мечты их не занимали прогулки по летним садам в сени пышных зелёных крон, и беззаботно резвиться в золотых лучах солнца было им не по нраву. Нет, по душе им были лишь трескучие зимние морозы да безжизненное серое небо, что не знает света. Они прокляли эту землю, и во многом сердца их были с нею похожи – жестокие, холодные, безжалостные.'
					}, {
						linebreak: 1
					}, {
						text: 'И в сердце того холодного замка жила принцесса по имени Алисия.'
					}, {
						text: 'Замок был полон народу, но всё же Алисия чувствовала себя совершенно одинокой, даже рядом с семьёй. Она во многом отличалась от своего народа. Члены её семьи были темноволосы и бледнокожи, её же волосы были приятного глазу розового оттенка, а кожа чуточку смугла и похожа на песок южный. Её народ заботило лишь господство над остальными народами, а её единственным желанием было создавать жизнь своими ледяными скульптурами.'
					}, {
						text: 'Алисия днями напролёт создавала целый мир в своей просторной комнате. Мир застывших существ.'
					}, {
						text: 'Она читала в книгах о разных диковинных существах за тридевять земель и воссоздавала их образы в скульптурах. Фавны, гиганты, кентавры, эльфы – все попадали в ледяной мирок Алисии. И для каждой скульптуры она искала совершенную позу, совершенный образ. Книги переполняли её чудеснейшими идеями, но всё же чего-то не хватало. Статуи были выполнены весьма мастерски… но не казались живыми.'
					}, {
						text: 'Её отцу и матери – Королю и Королеве – было не до полётов буйной фантазии, не до художеств и поэзии. Их дни проходили в планировании завоевания и порабощения других королевств. А в замке к захваченным рабам относились хуже, чем к скоту.'
					}, {
						text: 'Безусловно, Алисии было жаль тех бедолаг, но она не могла отделаться от мысли о том, чтобы взять себе одного из них… быть может, он привнес бы вдохновение в её искусство. То страдание, тот пылающий огонь свободы – не они ли есть самая суть жизни?'
					}, {
						linebreak: 1
					}, {
						text: 'Настал день рождения Алисии. К празднеству для неё сшили великолепное платье. Оно поражало красотой своей мрачности. Оно было цвета глубокого, тёмно-синего озера; инкрустированные в ткань кристаллы сверкающего красного льда были будто кровавыми звёздами, блуждающими по иссиня-чёрному ночному небу.'
					}, {
						text: 'Алисию вызвали в обеденную залу на великий пир в честь Её Высочества Принцессы. Зала была полна подданных из её народа – высокого, бледного, темноволосого, с угловатыми суровыми лицами. Даже в дружеской беседе у них не было и тени задора и тепла.'
					}, {
						text: 'Были поданы огромные горы яств, и ни одно не было Алисии по вкусу. Чёрные замороженные пироги, горький тёмный эль, мясо с кровью. Празднество казалось Алисии пустым, скучным почти до слёз. Безжизненно, мертвенно тоскливо. Алисия жаждала поскорее вернуться к своей работе. Чтобы продолжить поиски совершенного образа.'
					}, {
						text: 'Внезапный шум всполошил присутствующих, и так же быстро на пиршество опустилась тишина. Один из слуг – птицеподобное создание с красными перьями – случайно упал и разлил по полу напитки. Алисия наблюдала.'
					}, {
						text: '"Наконец-то, хоть какое-то развлечение" – подумала она.'
					}, {
						text: 'Королева встала во весь рост. На ней было длинное кроваво-красное платье. Её мертвенно бледная кожа, ярко-жёлтые глаза и чёрные, как перья ворона, волосы выглядели и без того устрашающе, но её божественно прекрасное лицо, искажённое гримасой ярости, наводило пробирающий до костей ужас.'
					}, {
						text: '– Эй, тварь! Раб! На колени предо мной сию же секунду! – сотрясла залу Королева, и бедное создание тут же поволокло свои красные пёрышки через весь холл, получая по дороги плевки и оплеухи от гостей.'
					}, {
						text: 'Существо встало на колени и согнулось в поклоне будто под весом громадных кристально-чёрных тронов королевской четы: "П-п-простите Вашего скромного слугу, Ваше Величество! Я случайно… я не хотел… кто-то поставил мне подножку!"'
					}, {
						text: '– Молчать! Что ты там бормочешь, жалкое ничтожество?! Я не разрешала тебе открывать свой рот! Похоже, у нас тут завёлся невероятно наглый раб, супруг мой? – властно произнесла Королева, и дьявольская улыбка исказила её уста.'
					}, {
						text: 'Её супруг, Король, неспешно кивнул, не проявляя никакого интереса к ситуации: "Так и есть, Королева-Мать".'
					}, {
						text: '– А мы из Карвока не терпим наглости! – Королева взметнула руку в воздух, и тут же из ничего в её ладони возник чёрный ледяной хлыст. Маленькой краснопёрое создание так сильно сжалось в комок от страха, что его перья начали выпадать. Королева не спеша подошла к птице и занесла над ней хлыст для удара.'
					}, {
						text: 'До этого мгновения Алисия лишь наблюдала, захваченная развитием событий. И тут, видя бедное создание в таком незавидном положении, она кое-что придумала.'
					}, {
						text: 'Хлыст уже с рёвом резал воздух на пути к беззащитному тельцу, как вдруг между ними возник ледяной барьер и отразил удар.'
					}, {
						text: 'Толпа вокруг загудела от увиденного. Лёд струился с кончиков пальцев Алисии, формируя щит вокруг бедняги раба. '
					}, {
						text: '– Пожалуйста, нет! Не делай ему больно, мама. Разве ты не видишь, что он сожалеет о содеянном? – умоляла Алисия с мастерством плохой актрисы, играющей капризную принцесску.'
					}, {
						text: 'Королева обернулась и посмотрела на Алисию взглядом, от которого могла буквально застыть кровь.'
					}, {
						text: '– КАК СМЕЕШЬ ТЫ перечить своей матери?! Своей Королеве! Живо в свою комнату! И остаёшься сегодня без ужина! – воскликнула Королева, а Алисия с трудом сдерживала улыбку. Её план сработал.'
					}, {
						text: 'Алисия развернулась и побежала в свою комнату, притворно рыдая. Но она в душе улыбалась, ведь пошла наперекор матери она лишь для того, чтобы её выгнали с пира. Родители её, может, и жестоки, но очень предсказуемы.'
					}, {
						text: 'Алисия взглянула на свои скульптуры. Она вздохнула уже в непритворной печали: вдохновение иссякло. В её холодный мир не заглядывали музы.'
					}, {
						text: 'Вид на небо из окна её спальни был привычен: хмурая пелена непроглядных туч лишь изредка давала звёздам возможность полюбоваться суровым севером. Но одна странная яркая звезда приковала взор Алисии. Крупная звезда переливалась песочно-золотым цветом, и таких юная принцесса раньше точно не видела.'
					}, {
						text: 'В книгах, что она читала, говорилось, что люди иногда загадывают желания, смотря на звезду, и их желания сбываются. Почему бы и ей не попробовать?'
					}, {
						image: 'https://battlerite-ru.github.io/lore/images/stories/alysia/whatNiceHandsYouHave.jpg'
					}, {
						text: '"Если кто-нибудь там, далеко, вдруг захочет меня услышать… вот моё желание. Я хочу покинуть этот замок, эту семью… такую жизнь, навсегда. И отправиться туда, где смогу отыскать вдохновение, где жизнь бьёт ключом… где буду жить искусством! Чтобы найти совершенный образ!"'
					}, {
						text: 'Золотая звезда сверкнула, будто ей в ответ, и исчезла.'
					}, {
						text: 'Алисия уже было отправилась спать в полной уверенности, что её желание было просто детской забавой, как вдруг песок заискрился подле её ног.'
					}, {
						text: 'Песок возникал из ниоткуда, струясь сверкающими нитями и собираясь в силуэт невиданного существа. Поражённая, Алисия глядела с разинутым ртом, как мохнатое кремово-жёлтое создание спокойно стряхивало остатки песка со своих плеч.'
					}, {
						text: '– Кажется, твой зов, минуя нити судеб и времён, привёл меня сюда, сейчас, в этот самый момент'
					}, {
						text: 'Алисия будто потеряла дар речи. С ней никогда не случалось ничего необычного, но вот сейчас, здесь, оно… произошло. Но что же это такое?'
					}, {
						text: '– Кто… кто ты? Как ты сюда попал?'
					}, {
						text: '– Что ж, похоже, что ты призвала меня сюда, юное создание. А кто я? Ну, в данный момент времени, думаю, зовут меня… Олдур. Рад познакомиться. – Олдур протянул свою мохнатую руку, и Алисия пожала её.'
					}, {
						text: '– Мне тоже очень приятно, Олдур. Я Алисия. Ты можешь помочь мне покинуть это мрачное место, как думаешь? Я хочу отыскать жизнь и вдохновение для моих скульптур.'
					}, {
						text: '– Конечно. Но моё прибытие сюда связано не столько с твоими желаниями, сколько с твоей ролью, которую ты сыграешь в будущем. Время – это необозримый океан, но каким-то образом твоё послание в бутылке прибило к берегам моих мыслей. Я не спрашиваю, я лишь служу.'
					}, {
						text: 'Странное существо озадачило Алисию. Что ей с ним делать?'
					}, {
						text: 'Олдур взмахнул лапами, и в воздухе возникло видение в рамке из сверкающего струящегося песка: "Смотри же, что лежит в глубинах памяти". Там были арены с битвами чемпионов, полные захватывающего действа, где жизнь и смерти зарождались и угасали. Сердца героев страстно пылали в разгаре битвы. Алисия смотрела на видение широко открытыми глазами. О таком месте она всегда мечтала.'
					}, {
						text: '– Да, молю! Я хочу туда! Там я точно отыщу себе совершенный образ!'
					}, {
						text: 'Олдур кивнул. Он поднял и перевернул свои песочные часы.'
					}, {
						text: '– Когда последняя песчинка упадёт, ты будешь свободна, юная Принцесса. Иди же. Вниз, в обеденную залу, и узри, что сделал я. И беги прочь, пока время на твоей стороне.'
					}, {
						text: 'И с этими словами Олдур превратился в песок, который закружился по комнате и снова исчез в никуда.'
					}, {
						text: 'Алисия осторожно на цыпочках прокралась на пир. Но встречена была лишь гробовой тишиной. Все гости были абсолютно недвижимы, будто застыли во времени. Её родители тоже стояли живыми статуями с гордыми высокомерными улыбками, застывшими на их лицах. Алисия восхитилась их красотой в неподвижности. Странно, но так они казались более живыми.'
					}, {
						text: 'Принцесса не могла поверить, что была свободна. Она вышла из замка прямо через парадные ворота. И не оглядывалась назад.'
					}, {
						text: 'Алисия впервые вдохнула свободу, идя навстречу новой жизни. Теперь она может показать всему миру своё искусство ледяной скульптуры. Она будет путешествовать по сказочным землям из легенд и преданий и найдёт тот самый совершенный образ.'
					}, {
						text: 'И впервые за очень долгое время…'
					}, {
						text: 'Алисия искренне улыбнулась.'
					}
				], 
				shifuLore = [
					{
						title: 'Завет и Наследник'
					}, {
						text: '"Нет противника сильнее ветра!", – закричал своему подопечному седовласый, покрытый морщинами мастер Шифу. "Путь Копья есть подчинение стихиям!" Шифу стоял подле арены и наблюдал за тем, как наследник и продолжатель его таинственного и мистического пути Ни’Шу бьётся насмерть. Он надеялся, что тот выживет.'
					}, {
						text: '"Я стараюсь, Мастер!", – ответил наследник, сжимая древко копья и парируя удар.'
					}, {
						text: "Лезвие копья наследника пронеслось мимо лица претендента. Но претендент оказался точнее. Рукоять его боевого топора нанесла сокрушительный удар по лицу наследника, оставив ужасную рваную рану. Во взгляде Шифу застыл ужас, и сердце его замерло. Претендент продолжил добивание, мощнейшим взмахом с разворота оставив в низу корпуса наследника глубокий порез."
					}, {
						text: "Наследник схватился за живот, ошеломлённый болью и видом непрекращающихся брызг собственной крови. Его взгляд беспорядочно сновал по арене, пока не остановился на Шифу, видевшем шок и боль мальчишки, совершенно не готового к смерти. Копьё выпало из рук бойца, и вслед за ним и он пал на землю."
					}, {
						text: "Шифу рванул на арену к мальчишке, тот лежал уже без движения. Глаза его были открыты, но жизнь в них уже угасла. Наследник Шифу, его воспитанник и продолжатель древнего Пути Копья, был повержен."
					}, {
						text: "Шифу встал на колени и прошептал своему павшему подопечному: "
					}, {
						text: '"Упрямый ты мальчуган. Говорил же тебе, арена – не место для экспериментов..." –  слеза скатилась по щеке Шифу, упала вниз и впиталась землю.'
					}, {
						text: "Лишь со смертью мальчика Шифу наконец признал в нём мужчину, а не невинное дитя. Этот момент напомнил ему конец его же детства, когда искра беззаботности пропала в его взгляде."
					}, {
						text: "Всю свою сознательную жизнь Шифу пытался забыть тот день, когда на него пало родовое проклятье. Но сегодня, стоя на коленях в крови своего наследника, эти воспоминания не могли не вспыхнуть в нём снова."
					}, {
						linebreak: 1
					}, {
						text: "Шифу рыдал, положив голову на колени сестры, отказываясь верить в безумие, происходившее вокруг. "
					}, {
						text: 'В домике его деда было тепло, но он ощущал лишь холод зимнего утра. Дед бранил его: "Слёзы ничего не значат для Тленного. Возьми себя в руки, мальчишка", – он изредка бросал взгляд в утомлённые, но скорбящие глаза своего деда, и пытался быть сильным... Но был всего лишь маленьким мальчиком, и слёзы было невозможно удержать. Тело его матери лежало подле него.'
					}, {
						text: "Над нею нависала размытая бурая тень, плавно принимающая форму тёмной пугающей человеческой фигуры. Её лицо было испещрено глубокими морщинами, будто кора старого дерева. Фигура стояла во весь рост, нависая над присутствующими, как тёмная, разрушенная башня. Будто плащом, её окутывало облако пепла. То был не человек и не зверь, не демон или ангел... Это было нечто зловещее, древнее существо из ветра и праха."
					}, {
						text: "У ног Тленного, больше походивших на грязные когтистые лапы, стоял на коленях, пресмыкаясь, дед Шифу, облачённый в лохмотья. Юный Шифу всё крепче прижимался к ногам сестры, а та гладила его щёки и голову, пытаясь хоть как-то успокоить."
					}, {
						text: '"Повелитель Земли и Воздуха, не нужно было её убивать", - рыдал дедушка.'
					}, {
						text: '"У неподчинения есть своя цена. Жизнь. Сие – наш договор и завет. И ваша плата. Укажи же своего наследника", – низкий голос Тленного звучал, как столкновение двух скал, как ураган поздней осенью, сбивающий с чащи леса последнюю листву."'
					}, {
						text: "Тленный неспешно обвил свои длинные, сухие, будто коряга, пальцы вокруг шеи покорного деда и поднял старика под потолок."
					}, {
						text: 'Шифу смотрел не отрываясь на то, как над полом беспорядочно дёргались ступни деда, необутые, испачканные, почти окаменевшие от десятилетий работы в поле. В мыслях Шифу была лишь одна мысль: "Дедушка. Пожалуйста. Просто подчинись". Глаза деда уже выкатывались из глазниц, ноги отчаянно пытались найти в воздухе опору, частые сдавленные вдохи едва ли продляли жизнь хоть на ещё одну секунду.'
					}, {
						text: 'Тленный неторопливо продолжал: "Ты скрывал от меня свой взгляд, но, как того спрашивает Закон, ты должен выбрать наследника Пути. Ежели наследника нет, чья-то жизнь полагается в расплату. Где твой наследник?"'
					}, {
						text: '"Он…" – едва дыша и пытаясь остаться в сознании, промолвил дед. Тленный бросил его на землю. Дед жадно глотал воздух и выдавил сквозь кашель: "Он умер. Болезнь, повелитель."'
					}, {
						text: '"Значит, он был отправлен к богам. А что же сын его? Для чего же ещё жить мужу, как не для передачи Пути своему отпрыску?"'
					}, {
						text: '"Но повелитель, его сын ещё совсем ребёнок!" – противился дед.'
					}, {
						text: '"Все мы были детьми. Возраст не освобождает тебя ни от злодеяний предков твоих, ни от завета, что был заключён меж ними и богами земли твоих праотцов."'
					}, {
						text: '"Будь проклят ты и твой чёртов завет!" – Дед Шифу схватил длинное магическое копьё, что стояло возле камина, его лезвие светилось в темноте. Он занёс копьё над Тленным.'
					}, {
						text: "Из земли в ту же секунду взвился прах и начал опутывать руки деда, сковывая его тело, пока то не срослось с землёй. Дед Шифу попытался закричать, но не издал ни звука. Он навеки застыл статуей из пепла и пыли."
					}, {
						text: 'Тленный оперся ногой на свежую статую и сказал: "Нужно ли напоминать мне вам о том, что ваши предки вторглись в Пещеру Ни\'Шу и выкрали древнее копьё. С тех самых пор ваши люди повязаны Заветом Копья. Род ваш должен нести бремя выбора мастера сего древнего искусства, и мастер должен выбирать себе наследника. Если же наследник не будет наречён к моему первому приходу, я забираю жизнь. Ко второму моему приходу в сезон жатвы ваш род и народ ваш будет поглощён землёю."'
					}, {
						text: 'Тленный продолжал: "Выбранный наследник получит силу земли и ветра, первородную силу. Чем моложе наследник, тем сила мощнее в нём. Вы уже совершили первую плату. Назови же нового наследника, или придётся заплатить... ещё одной жизнью."'
					}, {
						text: "Юный Шифу пребывал в ужасе. Его дед пошёл против богов, смотрел в лицо смерти. Возможно, и он сможет когда-нибудь встретиться с ними лицом к лицу."
					}, {
						text: '"Пощади моего деда, о, Повелитель Земли. Я – тот ребёнок, о котором он говорил". Дед был освобождён от пут земли, свалился наземь и прокашлялся кровью и песком.'
					}, {
						text: '"Обучи мальца. Он готов. Я чувствую, что сердце его… сильнее сердца твоего сына".'
					}, {
						image: 'https://battlerite-ru.github.io/lore/images/stories/shifu/whatBigEyesYouHave.jpg'
					}, {
						linebreak: 1
					}, {
						text: "Даже спустя столько лет, Шифу всё ещё трепетал от страха, вспоминая, как таинственное существо обернулось размытой тенью и туманом и растворилось в ночи. Он уставился на бездыханное тело наследника и огромное копьё подле него – настоящую реликвию, связывающую его с первородной силой земли и ветра."
					}, {
						text: "Его думы прервал звук лезвия топора, едва не угодившего ему в лицо. Шифу быстро поднял копьё. Оно грациозно завертелось в его руках, разрезая воздух со свистом, будто оклик старого приятеля."
					}, {
						text: "Он был сосредоточен, вдыхал воздух соревнования, запах крови и гниющей плоти прошлых битв, вонь смерти под несмолкающие звуки фанфар. Это была арена, где встреча со смертью дарует вкус жизни. Шифу обходил претендента по кругу, как лев наблюдает и изучает свою добычу. Претендент ударил топором наотмашь, Шифу уклонился без малейшего усилия."
					}, {
						text: '"Неплохо для такого молодого воина. Ты левша... Но это обман. Ясно, ты травмирован – не напрягаешь правую ногу. Стойка левши тебе в новинку. Центр тяжести не на месте. Арена может и не простить за такое, не так ли?"'
					}, {
						text: "Противник раздражённо зарычал в ответ и атаковал снова. Шифу ускользнул от лезвия топора, и претендент потерял баланс. Шифу в то же мгновение контратаковал взмахом Тройного Копья. Соперник снова взмахнул топором, Шифу пригнулся, прицелился и молнией яркого голубого света, будто морской волной, встречающей берег, пронёсся сквозь претендента. Шифу закрыл глаза, и вспышка молнии окружила его полупрозрачным свечением."
					}, {
						text: "Не видя Шифу, претендент опрометчиво взмахнул топором с разворота. Мастер Копья в бестелесной, невидимой форме в одно мгновение оказался подле соперника и одним пируэтом копья по сухожилиям ног претендента повалил того навзничь. Шифу приставил копьё к глотке претендента."
					}, {
						text: '"Я бы прикончил тебя, но земля уже насытилась кровью за сегодня. Покинь же мою арену и никогда не возвращайся".'
					}, {
						text: "Претендент отшвырнул свой топор и пустился наутёк. Шифу закрепил копьё за спиной и поднял бездыханное тело своего наследника."
					}, {
						text: "И, неся его на руках, будто убаюкивая малыша, он поплёлся с арены. Рёв толпы едва ли был громче шёпота для него. Холодный ветер ночи высушивал новые и новые слезы на его щеках."
					}, {
						linebreak: 1
					}, {
						text: "Настал рассвет, когда Шифу брёл по улицам столицы Куны, за защитными стенами знаменитого замка и его прекрасного Драконьего сада. Кровь капала на мощёную камнями дорогу и цветы небольших клумб у глиняных домов простолюдинов – плотников, рыбаков и кузнецов."
					}, {
						text: "Шифу принёс мальчика в своё жилище – маленькую комнату, первоначально предназначенную для слуг трона. Он нежно положил тело и обернул его простынями."
					}, {
						text: "По стене кралась тень, внезапно превратившись в нечто из тёмной дымки праха под оглушительный свист ветра. Всё это было знакомо Шифу. Тленный стоял пред ним."
					}, {
						text: '"Ты знаешь, зачем я здесь, Мастер Копья".'
					}, {
						text: '"Знаю. Вот твой наследник".'
					}, {
						text: "Тленный встал на колено и убрал простыню с мёртвого тела. Выругавшись на древнем языке, он поднялся, затем склонился над телом и провёл рукой, что-то прошептав. Труп обратился в прах, улетевший в то же мгновение прочь, в окно, едва поспевая за уходящей ночью."
					}, {
						text: '"Теперь он един с землёю", – Тленный встал и подошёл к Шифу.'
					}, {
						text: '"Значит, наследника у тебя нет. Ты знаешь цену."'
					}, {
						text: "Шифу схватил копьё и встал в боевую стойку, готовый бить первым. Молния сверкнула дугой в воздухе."
					}, {
						text: '"Удачи, дух. Я – не мой дед".'
					}, {
						text: '"Нет, ты – не он. Ты испытываешь моё милосердие, Мастер Копья. Я вернусь. И в следующий раз я буду не один. И тебе бы следовало к тому времени уже обзавестись наследником".'
					}, {
						text: "Тленный вновь обернулся смерчем из праха, дыма и тени и вылетел через окно."
					}, {
						text: "Шифу аккуратно поставил копьё у стены. Он без сил дополз до кровати, но сердце его неустанно пыталось сломать грудную клетку изнутри. На следующем восходе солнца он отправится в путешествие в поисках нового наследника и битвы за собственную жизнь и жизнь своего рода."
					}, {
						text: "Шифу закрыл глаза, пытаясь забыть свои печали, пока сон не овладел им."
					}
				],
                Q = a(176),
                J = [{
                    ...
                    content: lucieLore,
                    champion: "lucie",
					pinPreviewImage:"https://battlerite-ru.github.io/lore/images/stories/lucie/preview.png",
                    cardImage: "https://battlerite-ru.github.io/lore/images/stories/lucie/asdanfkjnweljbglsdfbgsel.jpg",
                    date: "2019-01-23",
                    status: "released",
                    _id: 12
                }, {
                    content: talonIslandLore,
                    champion: "talon_island",
                    championraw: "Остров Когтя",
					rawtext: true,
                    cardImage: "https://battlerite-ru.github.io/lore/images/stories/talonisland/TalonIsland04_tall.jpg",
                    date: "2019-01-30",
                    status: "released",
                    _id: 13
                }, {
                    content: alysiaLore,
                    champion: "alysia",
					pinPreviewImage:"https://battlerite-ru.github.io/lore/images/stories/alysia/preview.png",
                    cardImage: "https://battlerite-ru.github.io/lore/images/stories/alysia/whatNiceHandsYouHave.jpg",
                    date: "2019-03-25",
                    status: "released",
                    _id: 14
                }, {
                    content: shifuLore,
                    champion: "shifu",
					pinPreviewImage:"https://battlerite-ru.github.io/lore/images/stories/shifu/preview.png",
                    cardImage: "https://battlerite-ru.github.io/lore/images/stories/shifu/whatBigEyesYouHave.jpg",
                    date: "2019-05-09",
                    status: "featured",
                    _id: 15
                }, {
            ...
            var ae = function (e) {
                    ...
                    return Object(c.a)(t, e), Object(l.a)(t, [{
                        ...
                        key: "render",
                        value: function () {
							/* Easter Egg: #tryToDecode# */
							//(new PathMapLore()).setupLorePath();
                            var e = this,
                                t = null;
                    ...
                    return Object(c.a)(t, e), Object(l.a)(t, [{
                        ...
                        value: function () {
                            ...
                            return n.a.createElement("div", {
                                ...
                                }, (this.props.rawtext == true) ? this.props.championraw : (this.props.champion.toUpperCase()
                    ...
                    return Object(c.a)(t, e), Object(l.a)(t, [{
                        ...
                        value: function () {
                            ...
                            var e = Z.find(function (e) {
                                return window.location.pathname.includes(e.champion)
                            });
                            e && "preview" !== e.status && "hidden" !== e.status && this.setState({
                                storyId: e._id,
                                isModalOpen: !0
                            }), window.addEventListener("resize", this.handleResize)
                        }
                            ...
                            return Object(y.a)(Z)
                                ...
                                .map(function (t, a) {
                                    ...
                                    return a === Z.length - 1 && (i.marginBottom = "0px"), n.a.createElement(ie, {
                                        ...
                                        isMuted: e.props.isMuted,
                                        championraw: t.championraw,
                                        champion: t.champion,
                                        rawtext: t.rawtext == undefined ? false : t.rawtext,
                                        style: i,
                                        isReleased: o,
                                        status: t.status,
                                        date: t.date
                ...
                le = (a(511), a(513), a(515), function (e) {
                    function t() {
                        ...
                        Object(r.a)(this, t);
                        for (var o = arguments.length, i = new Array(o), s = 0; s < o; s++) i[s] = arguments[s];
                        return (a = Object(h.a)(this, (e = Object(d.a)(t)).call.apply(e, [this].concat(i)))).state = {}, a.itemFunc = function (e, t) {
							var o = a.props.isMobile ? a.props.height - 15 : a.props.width - 20;
							return e.paths.find(function (e) {
								return window.location.pathname.includes(e)
							}) && (a.props.isMobile && e.onMobile || !a.props.isMobile) ? n.a.createElement("div", {
                ...
                de = function (e) {
                    ...
                    return Object(c.a)(t, e), Object(l.a)(t, [{
                        ...
                        value: function () {
                            ...
                            return ("/lore/map/" !== this.props.history.location.pathname && !this.props.history.location.pathname.includes("/lore/stories/") && "/lore/" !== this.props.history.location.pathname || this.props.isMobile && "/lore/map/" === this.props.history.location.pathname) && this.props.history.push("/lore/"), n.a.createElement("div", null)
                        }
                    }]), t
                }(o.Component),
